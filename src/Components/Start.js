...
export default function Start({ sendData}) { 
  return (
    ...
    <div >
      <div className="navbar" style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 20px", height:"60px" }}>
        <div className="nav-left">
           <img src={logo} alt="logo" style={{height:"60px",width:"70px"}}/>
        </div>
        <div className="nav-right" style={{display:"flex",gap:"10px"}}>
            <button className="login-btn"  style={{width:"100px",height:"50px", backgroundColor:"#323131", color:"white",border:"none", borderRadius:"5px", fontSize:"17px"}}>Login</button>
            <button className="signup-btn"  style={{width:"100px",height:"50px", backgroundColor:"#323131", color:"white",border:"none", borderRadius:"5px", fontSize:"17px"}}>Sign Up</button>
        </div>
      </div>
     <div className="hero" style={{display:"flex",justifyContent:"flex-start",alignItems:"center",height:"70vh",backgroundColor:"white" }}>
       <div className="hero-left" style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",height:"70vh" ,width:"750px",textAlign:"center",backgroundColor:"white" }}>
        <h1 style={{fontSize:"50px",color:"#323131"}}>Job Tracker Application</h1>
        <p style={{fontSize:"15px",marginTop:"-30px",color:"#323131"}}>Manage your Jobs in a professional way</p>

        
        <button className="btn"  onClick={() => sendData(true)}>Dashboard</button>
      </div >
      <div className="hero-right" style={{backgroundColor:"green",height:"400px",width:"400px"}}>
<div className="c">
      <StyledWrapper>
      <div style={{backgroundColor:"white",height:"500px",width:"500px",display:"flex",justifyContent:"center",alignItems:"center",borderRadius:"10px"}}>
      ...
      <div style={{display:"flex",justifyContent:"center",alignItems:"center",height:"30px",fontSize:"12px" , marginTop:"50px" }}>
